-- ============================================================================
-- Migration 023: Update RAG query limits per new pricing model
--   Free      →    20 queries/month
--   Starter   →   150 queries/month
--   Pro       →   400 queries/month
--   Unlimited →   800 queries/month
--   Enterprise →  800 queries/month
-- ============================================================================
...
BEGIN
  ...
  v_limit := CASE v_tier
    ...
    ELSE 20  -- free (and any unknown tier)
  END;
