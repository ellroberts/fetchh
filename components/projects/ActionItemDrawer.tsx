...
import type { ActionItem } from './ActionItemCard'
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {item.source_chunk && (
          <section>
            <SectionLabel>Why (from your threads)</SectionLabel>
            <blockquote style={{
              margin: 0,
              padding: '12px 16px',
        ...
        <div style={{
          ...
          <span style={{
            ...
            {isDone ? 'This action is complete.' : 'Ready to mark this done?'}
          </span>
          <button
            onClick={handleToggle}
            disabled={toggling}
            style={{
              ...
              fontWeight: 'var(--font-weight-semibold)',
              fontFamily: 'var(--font-family-primary)',
              backgroundColor: isDone ? 'var(--color-surface-base)' : 'var(--color-primary-500)',
