...
export function AddActionModal({ content, defaultProjectId, onSave, onCancel }: AddActionModalProps) {
  ...
  return createPortal(
    ...
    >
      ...
      >
        <ModalHeader title="Add action" onClose={onCancel} closeDisabled={saving} />
        ...
        <ModalFooter>
          ...
          <Button variant="primary" onClick={handleSave} loading={saving}>Add action</Button>
        </ModalFooter>
      </div>
    </div>,
    document.body
